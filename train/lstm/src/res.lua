...
function res:update_avg_tensor(tensor1D_of_samples)
  if tensor1D_of_samples:dim()==0 then
    return
  end
  for i=1,tensor1D_of_samples:size(1) do
    local curr_sample = tensor1D_of_samples[i]
    self:update_avg(curr_sample)
  end
end
