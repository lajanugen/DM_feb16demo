...
cmd:text()
cmd:text('Prod lstm NN model to predict courses')
cmd:text()
cmd:text('Options')
--primary things to change
cmd:option('-savefile','h64-b1-lr2e-2','filename to autosave the checkpont to. Will be inside checkpoint_dir/')
...
-- define datasets
opt.batch_size = 1
local ds = dialogs('all', opt.batch_size)
